  ...
  return (
    <>
      ...
      >
        {data.map((item) => (
          <SwiperSlide>
            <div className=" h-80 rounded-2xl shadow-lg shadow-black opacity-70 mx-3 mb-16">
              <div>
                <img
                ...
                <div className="flex justify-between mx-3 space-x-3 pt-4">
                  ...
                  <button className="bg-gradient-to-r from-cyan-500 to-blue-500 w-32 font-semibold text-white
                   rounded-full">Sell</button>
                </div>
              </div>
            </div>
          </SwiperSlide>
